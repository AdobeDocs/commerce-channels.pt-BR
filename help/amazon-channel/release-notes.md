...
[!DNL Amazon sales channel]  4.4.2 é compatível com as versões 2.3.x e 2.4.0 do Adobe Commerce, mas só é compatível com as versões 2.4.1+, do Magento Open Source, Adobe Commerce e Adobe Commerce na infraestrutura em nuvem
...
Esta versão do [!DNL Amazon sales channel] O inclui as seguintes melhorias e correções.
...
[!DNL Amazon sales channel] O 4.2.0 é compatível com a versão 2.3.x do Adobe Commerce, mas só é compatível com as versões 2.4.x do Magento Open Source, Adobe Commerce e Adobe Commerce na infraestrutura em nuvem. Se você tiver uma [!DNL Amazon sales channel] instalada e tentar atualizar seu Adobe Commerce para a versão 2.4.0, será solicitado que você atualize a extensão antes de concluir a atualização do Adobe Commerce.
...
O Amazon Sales Channel 4.1.0 é compatível com o Adobe Commerce 2.3.x de Commerce Open Source, Adobe Commerce e Adobe Commerce na infraestrutura em nuvem. Esta versão do Amazon Sales Channel inclui aprimoramentos na interface do usuário, além de pequenas correções de erros.
...
O Amazon Sales Channel 4.0.0 é compatível com as versões 2.3.0, 2.3.1, 2.3.2, 2.3.3 e 2.3.4 do Magento Open Source, Adobe Commerce e Adobe Commerce na infraestrutura de nuvem. Esta versão do Amazon Sales Channel inclui muitas atualizações da interface do usuário, além de pequenas correções de erros.
...
O Amazon Sales Channel 3.0.1 é compatível com as versões 2.2.4+ e 2.3.x do Magento Open Source, Adobe Commerce e Adobe Commerce na infraestrutura em nuvem.
...
O Amazon Sales Channel 3.0.0 é compatível com as versões 2.2.4+ e 2.3.x do Magento Open Source, Adobe Commerce e Adobe Commerce na infraestrutura em nuvem.
