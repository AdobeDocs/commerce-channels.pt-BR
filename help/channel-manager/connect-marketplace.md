...
>[!NOTE]
>
>O Channel Manager requer uma conexão um para um entre uma conta Walmart e uma exibição de loja do Commerce. Não é possível conectar a mesma exibição de loja a várias contas do Walmart.
